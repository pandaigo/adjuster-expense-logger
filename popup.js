...
function winAnsiSafe(s) {
  return String(s == null ? '' : s).replace(/[Ā-￿]/g, '?');
}
...
async function buildExpensePdf({ deployment, expenses }) {
  ...
  // Footer disclaimer
  drawText(
    'Generated by Adjuster Expense Logger. This report is a personal expense summary; verify against carrier policy and IRS rules before submitting.',
